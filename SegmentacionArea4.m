function SegmentacionArea4
% Para coger los ficheros de su ubicación
cd('C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-05-06 Análisis 4º experimento\3HeLa TIFF_average\Average Cells');
...
for i=1:nI
 ...
 %% Células
 Celula_contraste=imadjust(Celula, [0.043 0.355], [0 1]); %8-bit= 10-90
 ...
 ruta = 'C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-05-06 Análisis 4º experimento\4a_Mascaras\Mascaras_celulas';
 filename = sprintf('Mascara_Cel%s.tif', nombre_exp(i));
 filepath = fullfile(ruta, filename);
 imwrite(final_cel_255, filepath);

 %% LDs
 cd('C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-05-06 Análisis 4º experimento\3HeLa TIFF_average\Average LD');
 L=dir('*.tif');
 LD=imread(L(i).name);
 LD(~binary_final_cel) = 0; %aplicar la máscara a los LDs
 %figure, imshow(LD), set(gcf, 'Name', 'LD tras aplicar mascara')
 LD_contraste=imadjust(LD, [0.137 0.512], [0 1]); %8-bit= 30-130
 ...
 %figure, histogram(vector_pixeles_etif_LD, 100), title('Histograma de Tamaños de LDs'); xlabel('Tamaño de área (píxeles)'); ylabel('Frecuencia')
 ...
 ruta2= 'C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-05-06 Análisis 4º experimento\4a_Mascaras\Mascaras_LD';

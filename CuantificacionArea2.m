...
archivo = 'AreaporAreaporCel2.xlsx';
...
for i = 1:2:num_vectores1-1
    vector_AYB = [tabla_areaporarea_final.Vectores_areaporarea{i}', tabla_areaporarea_final.Vectores_areaporarea{i+1}']; %aqui hemos traspuesto

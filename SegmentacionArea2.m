function SegmentacionArea2
% Para coger los ficheros de su ubicación
cd('C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-03-17 Análisis 2º experimento\HeLa TIFF_average\Cell');
...
for i=1:nI
 ...
 ruta = 'C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-03-17 Análisis 2º experimento\Mascaras\Mascaras_Celulas';
 filename = sprintf('Mascara_Cel%s.tif', nombre_exp(i));
 filepath = fullfile(ruta, filename);
 imwrite(final_cel_255, filepath);

 %% LDs
 cd('C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-03-17 Análisis 2º experimento\HeLa TIFF_average\LD\');
 L=dir('*.tif');
 LD=imread(L(i).name);
 ...
 ruta2= 'C:\Users\USUARIO\Documents\Estudios\Universidad\4to\4to Segundo Cuatri\TFG\TFG\Raman\2025-03-17 Análisis 2º experimento\Mascaras\Mascaras_LD';
